...
contract('VOCTOP25', function (accounts) {
  ...
  it('mintToken(_mintedAmount):only owner can mintToken', async function () {
    const other = accounts[2];
    try {
      const result = await token.mintToken(100, { from: other });
      assert.fail('should have thrown before');
    } catch (error) {
      assertRevert(error);
    }
  ...
  it('burn(_value):only owner can burn', async function () {
    ...
    await token.mintToken(100); 
    try {
      const result = await token.burn(100, { from: other });
      assert.fail('should have thrown before');
    } catch (error) {
      assertRevert(error);
    }
  ...
  it('burn(_value):should not burn more than a balance of account', async function () {
    ...
    try {
      const result = await token.burn(101);
      assert.fail('should have thrown before');
    } catch (error) {
      assertRevert(error);
    }
  ...
  it('burn(_value):should not burn if owner account is frozen', async function () {
    ...
    try {
      const result = await token.burnFrom(accounts[1], 100, { from: other });
      assert.fail('should have thrown before');
    } catch (error) {
      assertRevert(error);
    }
  ...
  it('burnFrom(_from, _value):should return correct balances after burnFrom total amount:totalSupply, balanceOf', async function () {
  ...
  it('burnFrom(_from, _value):should not burn more than a balance of account', async function () {
    ...
    try {
      const result = await token.burnFrom(accounts[1], 101);
      assert.fail('should have thrown before');
    } catch (error) {
      assertRevert(error);
    }
  ...
  it('transferFrom(_from, _to, _value):should throw an error when trying to transfer more than balance', async function () {
  ...
  it('transferFrom(_from, _to, _value):should throw an error when trying to transfer more than allowed', async function () {
  ...
  it('transferFrom(_from, _to, _value):should throw an error when trying to transfer without allowance', async function () {
  ...
  it('transferFrom(_from, _to, _value):should throw an error when trying to transfer from frozen account', async function () {
  ...
  it('transferFrom(_from, _to, _value):should throw an error when trying to transfer to frozen account', async function () {
